...
public class GymOwnerDAO implements GymOwnerInterfaceDAO {
    ...
    public List<GymOwner> getGymOwnerList() {
        ...
        try {
            ...
            statement = conn.prepareStatement(SQLConstant.FETCH_ALL_GYM_OWNERS_QUERY);
    ...
    public GymOwner loginGymOwner(String username,String password) {
        ...
        try {
            ...
            ResultSet result;
            try {
                statement = conn.prepareStatement(SQLConstant.LOGIN_GYM_OWNER);
    ...
    public GymOwner registerGymOwner(GymOwner gymOwner){
        try{
            conn  = DBConnection.connect();
            statement = conn.prepareStatement(SQLConstant.REGISTER_GYM_OWNER);
    ...
    public List<GymOwner> getPendingGymOwnerList() {
        ...
        try {
            conn = DBConnection.connect();
            statement = conn.prepareStatement(SQLConstant.FETCH_ALL_PENDING_GYM_OWNERS_QUERY);
            ResultSet rs = statement.executeQuery();
            while(rs.next()) {
    ...
    public void sendOwnerApprovalRequest(String gymOwnerId){
        ...
        try {
            ...
            statement = conn.prepareStatement(SQLConstant.SEND_GYM_OWNER_APPROVAL_REQ_QUERY);
    ...
    public void validateGymOwner(String gymOwnerId, int isApproved) {
        try {
            ...
            statement = conn.prepareStatement(SQLConstant.SQL_APPROVE_GYM_OWNER_BY_ID_QUERY);
