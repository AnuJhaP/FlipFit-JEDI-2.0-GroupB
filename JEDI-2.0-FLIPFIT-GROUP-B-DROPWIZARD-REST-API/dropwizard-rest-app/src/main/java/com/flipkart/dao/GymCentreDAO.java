...
import static com.flipkart.constant.SQLConstant.FETCH_GYM_CENTRE_BY_ID;
...
public class GymCentreDAO implements GymCentreInterfaceDAO {
    ...
    public List<GymCentre> getAllCentresByOwmerId(String gymOwnerId)  {
        ...
        try {
            ...
            statement = conn.prepareStatement(SQLConstant.FETCH_GYM_CENTRES_BY_OWNER_ID);
    ...
    public GymCentre addGymCentre(GymCentre centre) {
        ...
        try {
            ...
            statement = conn.prepareStatement(SQLConstant.ADD_GYM_CENTRE_QUERY);
    ...
    public List<GymCentre> getPendingGymCentreList() {
        ...
        try {
            ...
            statement = conn.prepareStatement(SQLConstant.FETCH_ALL_PENDING_GYM_CENTRES_QUERY);
...
//        System.out.println("IN VALIDATE GYM CENTRE");
        try {
            ...
            statement = conn.prepareStatement(SQLConstant.SQL_APPROVE_GYM_CENTRE_BY_ID_QUERY);
...
//        }
    ...
    public List<GymCentre> getGymCentreListByCity(String city) {
        ...
        try {
            ...
            statement = conn.prepareStatement(SQLConstant.FETCH_GYM_CENTRES_BY_CITY);
