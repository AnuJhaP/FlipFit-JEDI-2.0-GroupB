...
public class SQLConstants {
     ...
     * Slot SQL Queries
     */
    public static final String ADD_GYM_CENTRE_QUERY = "INSERT INTO  flipfit-schema.FlipFitGymCentre (centreId, ownerId, centreName, gstin, city, capacity, price, isApproved) VALUES (?, ?, ?, ?, ?, ?, ?, ?);";
    ...
    public static final String FETCH_GYM_CENTRES_BY_CITY = "SELECT * FROM flipfit-schema.FlipFitGymCentre where city = ?";
    public static final String FETCH_ALL_PENDING_GYM_CENTRES_QUERY = "SELECT * FROM flipfit-schema.FlipFitGymCentre  where isApproved = 2";
    ...
    public static final String FETCH_GYM_CENTRES_BY_OWNER_ID = "SELECT * FROM flipfit-schema.FlipFitGymCenter where ownerId = ?";
    ...
    public static final String FETCH_GYM_CENTRE_BY_ID = "SELECT * FROM flipfit-schema.FlipFitGymCentre where centreId = ?";
